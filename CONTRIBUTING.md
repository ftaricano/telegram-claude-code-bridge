# Contributing to TapAgent for Telegram
...
1. **Fork and clone the repository**:
   ```bash
   git clone https://github.com/your-username/tapagent-telegram.git
...
Thank you for contributing to TapAgent for Telegram.
