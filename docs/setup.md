...
uv tool install git+https://github.com/ftaricano/tapagent-telegram

# Or using pip
pip install git+https://github.com/ftaricano/tapagent-telegram
```
...
```bash
pip install "tapagent-telegram[voice]"
```
...
- **Issues**: [Open an issue](https://github.com/ftaricano/tapagent-telegram/issues)
