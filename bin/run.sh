...
KEYCHAIN_SERVICE="${KEYCHAIN_SERVICE:-tapagent-telegram::TELEGRAM_BOT_TOKEN}"
...
echo "starting tapagent-telegram env=$ENVIRONMENT timeout=${CLAUDE_TIMEOUT_SECONDS}s progress_interval=${TELEGRAM_PROGRESS_EDIT_INTERVAL}s oauth_token_file=$CLAUDE_OAUTH_TOKEN_FILE"
