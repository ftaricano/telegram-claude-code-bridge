...
- 4096-char splitting without silent tail truncation
...
class TestDraftStreamerTruncation:
    async def test_long_text_split_without_ellipsis(self, streamer, mock_bot):
        """Text longer than 4096 chars should be split without losing the head."""
        long_text = "x" * 5000
