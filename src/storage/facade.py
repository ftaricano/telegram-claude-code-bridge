...
class Storage:
    ...
    def __init__(self, database_url: str):
        ...
        self.topic_sessions = TopicSessionRepository(self.db_manager)
        self.goals = GoalRepository(self.db_manager)
        self.durability = DurabilityRepository(self.db_manager)
