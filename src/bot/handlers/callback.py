...
from ...claude.ask_user_question import (
    ask_user_question_callback_handler as _ask_user_question_callback_handler,
)
...
async def aq_callback_handler(
    update: Update, context: ContextTypes.DEFAULT_TYPE
) -> None:
    """Handle AskUserQuestion inline keyboard callbacks."""
    await _ask_user_question_callback_handler(update, context)
