...
class SecurityValidator:
    ...
    def validate_path(
        ...
        With ``check_patterns=False`` only the approved directory boundary is
        checked, after the path is resolved; ``DANGEROUS_PATTERNS`` are skipped.
        ...
        try:
            ...
            if check_patterns and not self.disable_security_patterns:
