...
class ClaudeIntegration:
    ...
    def __init__(
        ...
        self.goal_manager = GoalManager(goal_repo) if goal_repo is not None else None
        ...
        try:
            ...
            try:
                response = await self._execute(
                    ...
                    ask_user_question_bot=ask_user_question_bot,
                    ask_user_question_chat_id=ask_user_question_chat_id,
                    ask_user_question_thread_id=ask_user_question_thread_id,
                )
